...
import { buildWomenShopPath } from "../../user/utils/womenNavigation";
...
import womenTrendingRingsStacking from "@assets/trending/RingsStacking.png";
import womenTrendingSpiritualPicks from "@assets/trending/SpiritualPicks.png";
import womenCollectionSilverClassics from "@assets/collections/SilverClassics.png";
import womenCollectionGiftsForHer from "@assets/images/collections/GiftsForHer.png";
import womenCollectionBridalBliss from "@assets/images/collections/BridalBliss.png";
import womenCollectionOfficeChic from "@assets/images/collections/OfficeChic.png";
import womenCollectionBohoAnklets from "@assets/images/collections/BohoAnklets.png";
...
import womenOccasionTempleDate from "@assets/occasions/TempleDate.png";
...
import womenOccasionGotHitched from "@assets/occasions/GotHitched.png";
...
export const PAGE_SECTIONS = [
  {
    ...
    label: "Home Sections",
    description:
      "Manage the homepage narrative, hero banners, and product storytelling.",
  },
  {
    pageKey: "shop-men",
    label: "Shop for Men",
    description:
      "Manage the men's landing page banners, categories, and curated merchandising.",
  },
  {
    pageKey: "shop-women",
    label: "Shop for Women",
    description:
      "Manage the women's landing page banners, occasions, and curated product stories.",
  },
  {
    pageKey: "shop-family",
    label: "Shop for Family",
    description:
      "Manage the family landing page hero, collections, and product merchandising.",
  },
  {
...
const homeSections = [
  ...
  {
    pageKey: "home",
    sectionKey: "dynamic-promo-banner",
    sectionType: "banner",
    label: "Dynamic Promo Banner (After Categories)",
    isActive: true,
    sortOrder: 2.5,
    settings: {
      instruction: "Please use exact image ratios to avoid cropping: Web (Desktop) must be 4:1, and Phone (Mobile) must be 16:9."
    },
    items: [],
  },
  {
    ...
    items: [
      {
        ...
        extraImages: [prodPendant, prodWineEar, prodAnklet],
        limit: 12,
        productIds: [],
      },
      {
        ...
        extraImages: [prodEarring, prodPendant, prodRing],
        limit: 12,
        productIds: [],
      },
      {
        ...
        name: "Party Wear",
        image: bannerParty,
        tag: "Glamour And Shine",
        extraImages: [prodWineEar, prodWineRing, prodAnklet],
        limit: 12,
        productIds: [],
      },
      {
        ...
        image: bannerCasual,
        tag: "Relaxed Vibes",
        extraImages: [prodAnklet, prodBracelet, prodSis],
        limit: 12,
        productIds: [],
      },
    ],
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: "2",
        name: "Elegant Silver Rings",
        image: rings,
        path: "/shop?category=Rings&metal=silver",
      },
      {
        id: "3",
        name: "Silver Chains Collection",
        image: silverChains,
        path: "/shop?category=Chains&metal=silver",
      },
      {
        id: "4",
        name: "Men's Silver Boutique",
        image: menSilver,
        path: "/shop?search=men&metal=silver",
      },
      {
        id: "5",
        name: "Dazzling Silver Earrings",
        image: earrings,
        path: "/shop?category=Earrings&metal=silver",
      },
      {
        id: "6",
        name: "Sterling Style Highlights",
        image: brandVideo,
        type: "video",
        path: "/shop?metal=silver&sort=latest",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: "silver-launch-personalised",
        name: "Personalised",
        image: categoryPersonalised,
        path: "/category/personalised",
        tag: "New",
        categoryId: null,
      },
      {
        id: "silver-launch-earrings",
        name: "Earrings",
        image: catEarrings,
      ...
      {
        id: "silver-launch-mens",
        name: "Mens",
        image: categoryMensilver,
        path: "/category/men",
        tag: "New",
        categoryId: null,
      },
      {
        id: "silver-launch-perfumes",
        name: "Perfumes",
        image: categorySets,
    ...
    items: [
      {
        ...
        rating: 5,
        description:
          "The 925 silver ring I ordered is even more beautiful in person! The craftsmanship is exquisite, and the packaging felt so premium. It's my new favorite piece of jewelry.",
        location: "Mumbai",
      },
      {
        id: "testimonial-2",
      ...
      },
      {
        ...
        rating: 5,
        description:
          "I've purchased multiple items now, and they never disappoint. The 'Style It Your Way' collections are so well-curated. Elegant, timeless, and very classy design language.",
        location: "Bangalore",
      },
    ],
  },
    ...
    items: [
      {
        ...
        description:
          "Yes, all our jewellery is crafted from high-quality 925 Sterling Silver. Each piece comes with a hallmark stamp of authenticity so you can shop with confidence.",
      },
      {
        id: "faq-2",
        name: "How do I take care of my silver jewellery?",
        description:
          "To keep your silver shining, store it in the provided zip-lock bag when not in use. Avoid direct contact with perfumes, lotions, and harsh chemicals. You can gently clean it with a soft cloth.",
      },
      {
        id: "faq-3",
        name: "Do you offer a warranty on the plating?",
        description:
          "Absolutely! We offer a 6-month warranty on the gold and rose gold plating of our silver jewellery. If you face any issues, just reach out to us.",
      },
      {
        id: "faq-4",
        name: "What is your return and exchange policy?",
        description:
          "We offer a hassle-free 7-day return and exchange policy. If you are not completely satisfied with your purchase, you can return it in its original condition within 7 days.",
      },
    ],
  },
  {
...
const shopMenSections = [
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        path: buildMenShopPath({ category: "cufflinks" }),
      },
      {
        id: "men-chains",
        name: "Chains",
      ...
      {
        id: "men-spiritual-picks",
        name: "Spiritual Picks",
        image: "/images/men-categories/spiritual.png",
        path: buildMenShopPath({ search: "spiritual" }),
      },
      {
        id: "men-pendants",
        name: "Pendants",
      ...
      },
      {
        ...
        path: buildMenShopPath({ category: "sets" }),
      },
      {
        id: "men-personalised",
        name: "Personalised",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        path: buildMenShopPath({
          metal: "silver",
          silverType: "925 sterling silver",
        }),
        tag: "sterling",
      },
    ],
    ...
    items: [
      {
        ...
        extraImages: [
          exploreThumbRingDefault,
          exploreThumbChainDefault,
          exploreThumbRingDefault,
        ],
        categoryId: null,
        path: buildMenShopPath({ search: "edge" }),
      },
      {
        id: "men-explore-the-classics",
        name: "THE CLASSICS",
        subtitle: "Because classics never go out of style",
        image: exploreClassicsDefault,
        extraImages: [
          exploreThumbPendantDefault,
          exploreThumbChainDefault,
          exploreThumbChainDefault,
        ],
        categoryId: null,
        path: buildMenShopPath({ search: "classic" }),
      },
      {
        ...
        categoryId: null,
        path: buildMenShopPath({ search: "street" }),
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      {
        id: "men-glam-party-spark",
        name: "Party Spark",
        image: glamPartySparkDefault,
        categoryId: null,
        path: buildMenShopPath({ category: "party-spark" }),
      },
      {
        id: "men-glam-wedding-jewels",
        name: "Wedding Jewels",
        image: glamWeddingJewelsDefault,
        categoryId: null,
        path: buildMenShopPath({ category: "wedding-jewels" }),
      },
      {
        id: "men-glam-ritual-range",
        name: "Ritual Range",
        image: glamRitualRangeDefault,
        categoryId: null,
        path: buildMenShopPath({ category: "ritual-range" }),
      },
      {
        id: "men-glam-daily-wear",
        name: "Daily Wear",
        image: glamDailyWearDefault,
        categoryId: null,
        path: buildMenShopPath({ category: "daily-wear" }),
      },
      {
        id: "men-glam-office-wear",
        name: "Office Wear",
        image: glamOfficeWearDefault,
        categoryId: null,
        path: buildMenShopPath({ category: "office-wear" }),
      },
    ],
  },
  {
...
const shopWomenSections = [
    ...
    items: [
      {
        id: "women-rings",
        name: "Rings",
        image: womenCategoryRings,
        path: buildWomenShopPath({ category: "rings" }),
      },
      {
        id: "women-earrings",
        name: "Earrings",
        image: womenCategoryEarrings,
        path: buildWomenShopPath({ category: "earrings" }),
      },
      {
        id: "women-bracelets",
        name: "Bracelets",
        image: womenCategoryBracelets,
        path: buildWomenShopPath({ category: "bracelets" }),
      },
      {
        id: "women-pendants",
        name: "Pendants",
        image: womenCategoryPendants,
        path: buildWomenShopPath({ category: "pendants" }),
      },
      {
        id: "women-chains",
        name: "Chains",
        image: womenCategoryChains,
        path: buildWomenShopPath({ category: "chains" }),
      },
      {
        id: "women-bangles",
        name: "Bangles",
        image: womenCategoryBangles,
        path: buildWomenShopPath({ category: "bangles" }),
      },
      {
        id: "women-sets",
        name: "Sets",
        image: womenCategorySets,
        path: buildWomenShopPath({ category: "sets" }),
      },
      {
        id: "women-personalised",
        name: "Personalised",
        image: womenCategoryPersonalised,
    ...
    items: [
      {
        id: "women-trend-1",
        name: "Rings Stacking",
        image: womenTrendingRingsStacking,
        categoryId: null,
      ...
      },
      {
        id: "women-trend-4",
        name: "Spiritual Picks",
        image: womenTrendingSpiritualPicks,
        categoryId: null,
  ...
  },
  {
    ...
    items: [
      {
        id: "women-curated-1",
        name: "925 Silver Classics",
        image: womenCollectionSilverClassics,
        categoryId: null,
        path: buildWomenShopPath({ filter: "womens", category: "rings" }),
      },
      {
      ...
      },
      {
        id: "women-curated-3",
        name: "Boho Anklets",
        image: womenCollectionBohoAnklets,
        categoryId: null,
      ...
      },
      {
        id: "women-curated-4",
        name: "Gifts for Her",
        image: womenCollectionGiftsForHer,
        categoryId: null,
        path: buildWomenShopPath({ filter: "womens", category: "pendants" }),
      },
      {
        id: "women-curated-5",
        name: "Bridal Bliss",
        image: womenCollectionBridalBliss,
        categoryId: null,
        path: buildWomenShopPath({ filter: "womens", category: "sets" }),
      },
      {
        id: "women-curated-6",
        name: "Office Chic",
        image: womenCollectionOfficeChic,
        categoryId: null,
  ...
  },
  {
    ...
    items: [
      {
        id: "women-personalized-main",
        name: "Exclusive Edit",
        label: "Personalised",
        subtitle: "Silver that feels like you",
        image: womenPersonalizedBannerDefault,
        categoryId: null,
        path: buildWomenShopPath({
          filter: "womens",
  ...
  },
  {
    ...
    settings: {
      ...
      sourceMode: "category",
      categoryId: null,
      ctaLabel: "Explore All Women's Jewellery",
    },
    items: [],
  },
];
...
const shopFamilySections = [
    ...
    items: [
      {
        id: "family-hero-1",
        name: "For Everyone",
        label: "Jewellery Stories for the Whole Family",
        subtitle:
          "Giftable collections and timeless pieces for every celebration.",
        image: familyHeroDefault,
        path: "/shop",
        tag: "Shop for Family",
  ...
  },
  {
    ...
    items: [
      {
        id: "family-relation-all",
        name: "ALL",
        subtitle: "Every loved one",
        image: giftMother,
        relationKey: "all",
        path: "/category/family",
      },
      {
        id: "family-relation-mother",
        name: "MOTHER",
        subtitle: "Graceful keepsakes",
        image: giftMother,
        relationKey: "mother",
        path: "/category/family/mother",
      },
      {
        id: "family-relation-father",
        name: "FATHER",
        subtitle: "Classic silver picks",
        image: giftHusbandSilver,
        relationKey: "father",
        path: "/category/family/father",
      },
      {
        id: "family-relation-brother",
        name: "BROTHER",
        subtitle: "Bold everyday styles",
        image: giftBrotherSilver,
        relationKey: "brother",
        path: "/category/family/brother",
      },
      {
        id: "family-relation-sister",
        name: "SISTER",
        subtitle: "Delicate favourites",
        image: giftSister,
        relationKey: "sister",
        path: "/category/family/sister",
      },
      {
        id: "family-relation-husband",
        name: "HUSBAND",
        subtitle: "Signature essentials",
        image: giftHusbandSilver,
        relationKey: "husband",
        path: "/category/family/husband",
      },
      {
        id: "family-relation-wife",
        name: "WIFE",
        subtitle: "Elegant gifting edits",
        image: giftWife,
        relationKey: "wife",
        path: "/category/family/wife",
      },
    ],
  },
  {
    ...
    items: [
      {
        id: "classics",
        name: "925 SILVER CLASSICS",
        image: familyCuratedClassics,
        path: "/shop?source=family&filter=family",
      },
      {
        id: "astra",
        name: "ASTRA EDITION",
        image: familyCuratedAstra,
        path: "/shop?source=family&filter=family",
      },
      {
        id: "signature",
        name: "SIGNATURE SETS",
        image: familyCuratedSignature,
        path: "/shop?source=family&filter=family",
      },
      {
        id: "boho",
        name: "BOHO ANKLETS",
        image: familyCuratedBoho,
        path: "/shop?source=family&filter=family",
      },
      {
        id: "bridal",
        name: "BRIDAL EDIT",
        image: latestEarrings,
        path: "/shop?source=family&filter=family",
      },
      {
        id: "gifts",
        name: "GIFTS FOR HER",
        image: familyCuratedSisters,
        path: "/shop?source=family&filter=family",
      },
    ],
  },
    ...
    items: [
      {
        ...
        subtitle:
          "Choose the bonds that last a lifetime with our curated masterpiece collection.",
  ...
  },
  {
    ...
    settings: {
      ...
      tabConfigs: {
        all: {
          tabLabel: "All Family Collections",
          productLimit: 8,
          sourceMode: "category",
          categoryId: "",
          productIds: [],
    ...
    items: [
      {
        ...
        name: "Yellow Gold",
        image: categoryGoldPendant,
        gradient: "bg-gradient-to-tr from-[#DEB36D] to-[#F7E2AF]",
      ...
      },
      {
        ...
        name: "Rose Gold",
        image: categoryGoldBracelet,
        gradient: "bg-gradient-to-tr from-[#E6A0A0] to-[#FAD4D4]",
      ...
      },
      {
        ...
        name: "White Gold",
        image: categoryPersonalised,
        gradient: "bg-gradient-to-tr from-[#C0C0C0] to-[#E8E8E8]",
      ...
      },
      {
        ...
        name: "Dual Tone",
        image: categoryGoldPendant,
        gradient: "bg-gradient-to-tr from-[#E8C59A] via-[#E8E8E8] to-[#E6A0A0]",
        path: "/shop?metal=gold&search=Dual+Tone",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        rating: 5,
        description:
          "This time for our 5th year anniversary I wanted to gift her something different. Glad I got to custom make a modern solitaire ring for her...simple yet different, and exactly what I had pictured.",
        location: "Mumbai",
      },
      {
      ...
      },
      {
        ...
        rating: 5,
        description:
          "Wanted something special and matchy for my sister. So I got these rings custom-made with our coloured diamonds. And well, diamonds are a girl's best friend for a reason!",
        location: "Mumbai",
      },
    ],
  },
...
const withSectionIdentity = (section) => ({
  ...
  sectionId:
    section.sectionId ||
    buildSectionIdentity(section.pageKey || "home", section.sectionKey),
});

export const sectionDefaults = Object.values(sectionDefaultsByPage)
  .flat()
  .map(withSectionIdentity);

export const getSectionDefaultsForPage = (pageKey) =>
  (sectionDefaultsByPage[pageKey] || []).map(withSectionIdentity);

export const getPageConfig = (pageKey) =>
  PAGE_SECTIONS.find((page) => page.pageKey === pageKey) || PAGE_SECTIONS[0];
