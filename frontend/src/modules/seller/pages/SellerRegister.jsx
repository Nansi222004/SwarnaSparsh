...
const SellerRegister = () => {
            ...
            <div className="min-h-screen bg-[#FAF8F5] flex items-center justify-center p-6">
                <div className="max-w-md w-full bg-white rounded-[2.5rem] p-12 shadow-2xl text-center space-y-6 border border-white animate-in zoom-in-95 duration-500 font-sans">
                    ...
                    <button 
                        ...
                        className="w-full bg-[#141211] text-white py-4 rounded-xl font-black uppercase tracking-[0.2em] text-xs shadow-xl shadow-black/20 hover:bg-[#1C1917] hover:text-[#E8D198] transition-all"
                    >
                        Log In Now
                    </button>
                </div>
    ...
    return (
        <div className="min-h-screen bg-[#FAF8F5] flex flex-col lg:flex-row lg:overflow-hidden font-sans">
            {/* Left: Design/Branding */}
            <div className="hidden lg:flex lg:w-1/2 relative bg-[#141211] items-center justify-center p-12 overflow-hidden">
                ...
                <div className="relative z-10 max-w-lg text-center">
                    <h1 className="text-6xl font-black text-white uppercase tracking-tighter mb-6 leading-none">Strategic <br/><span className="text-[#E8D198]">Alliance</span></h1>
            ...
            <div className="w-full lg:w-1/2 min-h-screen lg:h-screen flex flex-col justify-center p-6 lg:p-12 lg:overflow-hidden bg-[#FAF8F5]">
