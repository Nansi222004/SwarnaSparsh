            ...
            {seller.status === "PENDING_PROFILE" ? (
              <>
                ...
                <p className="text-gray-500 text-sm leading-relaxed font-semibold">
                  Welcome to Swarna Sparsh! To begin selling on our platform, please fill in your firm type, bank account details, and upload the required business verification documents in your profile.
                </p>
              </>
            ) : (
              <>
