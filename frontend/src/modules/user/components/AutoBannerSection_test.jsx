        ...
        <section className="w-full relative overflow-hidden bg-white pt-10 md:pt-16 pb-0">
            <div className="container mx-auto px-4 mb-8 md:mb-12 text-center">
                <motion.span 
                    ...
                    viewport={{ once: true }}
                    className="text-[#C59B27] text-[10px] md:text-xs font-bold tracking-[0.4em] uppercase mb-3 block"
                >
                    Premium Narrative
                </motion.span>
                <motion.h2 
                ...
                <div className="w-12 h-[2px] bg-[#C59B27]/40 mx-auto mt-4 rounded-full" />
            </div>
                                ...
                                <div className="max-w-4xl space-y-4 md:space-y-6 pointer-events-auto">
                                    ...
                                    >
                                        <Link
                                            ...
                                            className="inline-flex items-center justify-center rounded-lg bg-[#141211] hover:bg-[#1C1917] hover:text-[#E8D198] px-8 py-3 text-[10px] md:text-xs font-bold uppercase tracking-[0.3em] text-white transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105 cursor-pointer active:scale-95"
                                        >
