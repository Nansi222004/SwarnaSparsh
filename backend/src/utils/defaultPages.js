const defaultPages = {
  "jewelry-care": {
    ...
    content: `
      ...
      <ul>
        <li><strong>Last On, First Off:</strong> Always put on your jewellery after applying cosmetics, hairspray, perfumes, lotions, and sunscreens. Chemicals in beauty products can dull the polished surface and cause tarnishing.</li>
        <li><strong>Avoid Water Exposure:</strong> Remove rings, bracelets, and necklaces before washing hands, showering, swimming in chlorinated pools, or soaking in hot tubs.</li>
        <li><strong>Physical Activity:</strong> Take off your jewellery before vigorous workouts, sports, gardening, or household chores to avoid accidental scratches, impact, or bent prongs.</li>
      </ul>
      ...
      <h3>3. Cleaning & Maintaining 925 Sterling Silver</h3>
      <ul>
        <li><strong>Microfiber Polishing:</strong> Gently wipe your jewellery with a soft, lint-free microfiber cloth or specialized silver polishing cloth after every wear to remove natural skin oils and moisture.</li>
        <li><strong>Deep Cleaning:</strong> For occasional deeper cleaning, prepare a gentle bath of lukewarm water with a few drops of mild, pH-neutral soap. Soak for 3 to 5 minutes, gently brush crevices with an ultra-soft baby toothbrush, rinse thoroughly under clean running water, and pat completely dry with a soft towel.</li>
        <li><strong>Never Use Harsh Chemicals:</strong> Do not use toothpaste, baking soda, bleach, acetone, or abrasive scrubbers, as they can permanently scratch the metal and erode protective plating.</li>
      </ul>

      <h3>4. Gemstones & Pearl Care</h3>
  ...
  "about-us": {
    ...
    content: `
      ...
      <ul>
        <li><strong>Certified 925 Sterling Silver:</strong> Every silver creation contains 92.5% pure silver, hallmarked and stamped with authenticity.</li>
        <li><strong>Conflict-Free & Ethically Sourced:</strong> We adhere strictly to ethical sourcing practices across all precious metals and hand-selected stones.</li>
        <li><strong>Fair Artisan Partnerships:</strong> We believe in empowering our master artisans with dignified compensation, safe workspaces, and lifelong creative recognition.</li>
      </ul>
  ...
  "terms-conditions": {
    ...
    content: `
      ...
      <h3>2. Product Information & Pricing</h3>
      <ul>
      ...
      <ul>
        <li>Orders are confirmed only upon successful payment authorization or confirmation of valid Cash on Delivery (COD) details.</li>
        <li>We accept major Credit/Debit Cards, UPI, Net Banking, and select digital wallets through RBI-compliant secure payment gateways.</li>
      </ul>
  ...
  "privacy-policy": {
    ...
    content: `
      ...
      <ul>
        <li><strong>Personal Identifiers:</strong> Name, shipping address, billing address, phone number, and email address provided during checkout or account registration.</li>
        <li><strong>Order & Transaction Records:</strong> Purchased items, sizes, custom engravings, and payment confirmation tokens (we do not store CVVs or credit card PINs).</li>
        <li><strong>Device & Browsing Data:</strong> IP address, device type, browser specifications, and cookie preferences used to optimize your browsing experience.</li>
      </ul>

      <h3>2. How We Use Your Information</h3>
      <ul>
        <li>To process, pack, insure, and dispatch your precious jewellery orders.</li>
        <li>To deliver automated order status notifications, tracking links, and customer support communications.</li>
        <li>To detect, prevent fraud, and comply with statutory GST/KYC compliance standards.</li>
      </ul>
  ...
  "shipping-policy": {
    ...
    content: `
      ...
      <ul>
        ...
        <li><strong>Customized & Engraved Pieces:</strong> Please allow an additional 3 to 5 crafting days prior to dispatch.</li>
      </ul>

      <h3>2. Free Insured Shipping</h3>
  ...
  "cancellation-policy": {
    ...
    content: `
      ...
      <p>We want you to be delighted with your shopping experience. If you need to cancel an order, please review our cancellation policy below:</p>

      <h3>1. Cancellations Before Dispatch</h3>
      <p>You may cancel your order free of charge at any time before it has been packed and dispatched from our fulfillment center. You can initiate a cancellation directly from the <em>My Orders</em> tab in your profile or by contacting customer support.</p>

      <h3>2. Custom & Personalized Orders</h3>
      <p>Orders involving personalized nameplates, custom ring sizes, or bespoke engravings cannot be cancelled once manufacturing has commenced.</p>

      <h3>3. Refund for Cancelled Orders</h3>
      <p>For prepaid orders cancelled before shipment, a 100% full refund will be processed immediately to your original payment method. Depending on your banking institution, funds will reflect in your account within 3 to 5 business days.</p>
    `
  },
  "return-refund-policy": {
    ...
    content: `
      ...
      <ul>
        <li>The item must be unused, unworn, and in its pristine original condition.</li>
        <li>All original packaging, warranty cards, authenticity certificates, and tags must be intact.</li>
        <li>Custom-engraved or personalized jewellery pieces are not eligible for returns unless defective upon arrival.</li>
      </ul>

      <h3>2. Free Return Pickup</h3>
      <p>We arrange complimentary insured courier pickups for eligible returns from your doorstep. Once scheduled, our logistics partner will verify the tamper seal and collect the package.</p>

      <h3>3. Refund Processing</h3>
      <p>Upon receipt at our quality inspection center, our gemologists will inspect the piece within 48 hours. Upon approval, your refund will be credited directly to your original payment method or bank account within 3 to 7 business days.</p>
    `
  },
  "warranty-info": {
    slug: "warranty-info",
    ...
    content: `
      ...
      <p>We provide a <strong>Lifetime Purity Guarantee</strong> on all our 925 Sterling Silver and Gold creations. Our items are hallmarked in compliance with national BIS standards.</p>

      <h3>2. 6-Month Manufacturing Warranty</h3>
  ...
  "our-craftsmanship": {
    ...
    content: `
      ...
      <h3>2. Precision & Hallmarking</h3>
      <p>While honoring age-old handcrafting techniques, we embrace cutting-edge laser soldering and microscopic setting technologies to guarantee precision prong tension and lasting durability.</p>

      <h3>3. Sustainable Silversmithing</h3>
      <p>We practice responsible silversmithing, reclaiming precious scrap, employing closed-loop water treatment in our workshops, and prioritizing zero-emission melting methods.</p>
    `
  },
  "customization": {
    slug: "customization",
    title: "Bespoke & Customization Services",
    content: `
      ...
      <ol>
        <li><strong>Design Consultation:</strong> Share your sketches, inspirations, or ring ideas with our master designers in person or via virtual appointment.</li>
        <li><strong>3D CAD Preview:</strong> We create a photorealistic 3D digital model and wax prototype for your approval, ensuring every proportion is flawless.</li>
